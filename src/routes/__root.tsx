...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Paula Sprzątanie — Profesjonalne sprzątanie w Krakowie" },
          ...
          "@graph": [
            {
              ...
              image: "https://paulasprzatanie.pl/og-image.jpg",
              priceRange: "$$",
            ...
            },
            {
              ...
              name: "Paula Sprzątanie",
              url: "https://paulasprzatanie.pl",
              logo: "https://paulasprzatanie.pl/logo.png",
              contactPoint: {
                "@type": "ContactPoint",
                telephone: "+48 600 000 000",
